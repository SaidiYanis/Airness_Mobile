...
class MeubleRepository {
    ...
    fun getMeubles(): List<Meuble> {
        ...
        return listOf(
            Meuble(1, "Table Noir Thormund", "Une belle table en bois massif noir avec des pieds en acier, idéale pour ajouter une touche de sophistication à votre salle à manger.", 1, 199.99, "table", "black", "acier"),
            Meuble(2, "Chaise Noire Nordik", "Une chaise confortable en bois noir, alliant un design épuré à un confort optimal, parfaite pour une salle à manger moderne.", 2, 49.99, "chair", "black", "bois"),
